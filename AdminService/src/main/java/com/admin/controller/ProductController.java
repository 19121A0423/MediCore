...
public class ProductController {
	...
	public ResponseEntity<Product> update(@RequestBody Product product, @PathVariable Integer productId) {
	...
	public ResponseEntity<List<Product>> searchSimilarProducts(
	...
	public ResponseEntity<List<Product>> searchProductByCategoryName(
