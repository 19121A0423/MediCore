...
public class CategoryController {
	...
	public ResponseEntity<Category> save(@RequestBody Category category) {
		...
		ResponseEntity<Category> entity = new ResponseEntity<Category>(category, HttpStatus.CREATED);
		return entity;
	}
	...
	public ResponseEntity<CategoryEntity> getById(@PathVariable Integer categoryId) {
		...
		ResponseEntity<CategoryEntity> entity = new ResponseEntity<CategoryEntity>(category, HttpStatus.OK);
		return entity;
	}
	...
	public ResponseEntity<List<CategoryEntity>> getAll() {
		...
		ResponseEntity<List<CategoryEntity>> entity = new ResponseEntity<List<CategoryEntity>>(categories,
				HttpStatus.OK);
		return entity;
	}
	...
	public ResponseEntity<String> deleteById(@PathVariable Integer categoryId) {
		...
		try {
			...
			return new ResponseEntity<String>("Category record deleted successfuly ", HttpStatus.OK);
